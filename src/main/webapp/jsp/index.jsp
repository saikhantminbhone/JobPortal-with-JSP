...
<br><br>
 ...
 <div class="section">
  <div class="slider">
    <div class="hero-container slidercontent">
      <h1 class="hero">Highest paying job search</h1>
      <h2 class="hero">Join the #1
job search site
for $100K+ jobs</h2>

      <div class="call"><i class="fa fa-angle-double-down"></i></div>
    </div>
  </div>
</div>
<div class="section">
