...
<div class="success">
      ...
      <div class="success-icon" style="border-radius:200px; height:200px; width:200px; background: #F8FAF5; margin:0 auto;">
        <i class="fa fa-check"></i>
      </div>
        <h1 class="success-text">Successfully Invited</h1> 
        <p class="success-subtext">We received your invite user request <br/> we'll be in touch shortly!</p>
        <a class="btn btn-primary btn-lg" href="Admin" role="button">Return</a>
      </div>
      </div>
