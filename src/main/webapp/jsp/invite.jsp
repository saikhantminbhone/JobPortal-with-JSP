...
<div class="container">
<div class="jumbotron">
  <h1 class="display-4">Please confirm user email</h1>
  <p class="lead">To send the invitation message please, fill message</p>

</div>
<div class="mb-4">
  <label for="exampleFormControlInput1" class="form-label">Email address</label>
  <input type="email" class="form-control" id="exampleFormControlInput1" value="<s:property value="email" />">
</div>
<div class="mb-4">
  <label for="exampleFormControlTextarea1" class="form-label">Message</label>
  <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
</div>
     <a href="invited"><button type="button" class="btn btn-primary ">Invite</button></a>
